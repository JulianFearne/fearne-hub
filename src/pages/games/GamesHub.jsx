...
const GAMES = [
  ...
  },
  {
    key: 'pictionary',
    title: 'Pictionary',
    blurb: 'Word generator for drawing games, with categories and a timer.',
    icon: 'pencil',
    to: '/games/pictionary',
    tags: ['Pass and play, offline'],
    live: true,
  ...
  },
  {
    key: 'memory-match',
    title: 'Memory Match',
    blurb: 'Flip pairs of cards and remember where everything is.',
    icon: 'layout-grid',
    to: '/games/memory-match',
    tags: ['1+ players, offline'],
    live: false,
  },
  {
    key: 'battleship',
